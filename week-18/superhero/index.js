...
const mainElem = document.querySelector(".superheroes");

superHeroes.forEach((superHero) => {
	const mainBlock = document.createElement("div");
	mainBlock.classList.add("mainBlock");
	mainElem.append(mainBlock);

	const nameHero = document.createElement("div");
	nameHero.classList.add("nameHero");
	nameHero.innerHTML = superHero.name;
	mainBlock.append(nameHero);

	const universeHero = document.createElement("div");
	universeHero.classList.add("universeHero");
	universeHero.innerHTML = `Вселенная: ${superHero.universe}`;
	mainBlock.append(universeHero);

	const alteregoHero = document.createElement("div");
	alteregoHero.classList.add("alteregoHero");
	alteregoHero.innerHTML = `Альтер эго: ${superHero.alterego}`;
	mainBlock.append(alteregoHero);

	const occupationHero = document.createElement("div");
	occupationHero.classList.add("occupationHero");
	occupationHero.innerHTML = `Род деятельности: ${superHero.occupation}`;
	mainBlock.append(occupationHero);

	const friendsHero = document.createElement("div");
	friendsHero.classList.add("friendsHero");
	friendsHero.innerHTML = `Друзья: ${superHero.friends}`;
	mainBlock.append(friendsHero);

	const superpowersHero = document.createElement("div");
	superpowersHero.classList.add("superpowersHero");
	superpowersHero.innerHTML = `Суперсилы: ${superHero.superpowers}`;
	mainBlock.append(superpowersHero);

	const urlHero = document.createElement("img");
	urlHero.classList.add("urlHero");
	urlHero.setAttribute("src", superHero.url);
	mainBlock.append(urlHero);

	const ratingArea = document.createElement("div");
	ratingArea.classList.add("rating-area");
	mainBlock.append(ratingArea);

	const starOne = document.createElement("input");
	starOne.type = "radio";
	starOne.id = "star-1";
	starOne.classList.add("rating-area");
	const starOneLabel = document.createElement("label");
	starOneLabel.for = "star-1";
	starOneLabel.classList.add("rating-area");
	ratingArea.append(starOne);
	ratingArea.append(starOneLabel);

	const starTwo = document.createElement("input");
	starTwo.type = "radio";
	starTwo.id = "star-2";
	starTwo.classList.add("rating-area");
	const starTwoLabel = document.createElement("label");
	starTwoLabel.for = "star-2";
	starTwoLabel.classList.add("rating-area");
	ratingArea.append(starTwo);
	ratingArea.append(starTwoLabel);

	const starThree = document.createElement("input");
	starThree.type = "radio";
	starThree.id = "star-3";
	starThree.classList.add("rating-area");
	const starThreeLabel = document.createElement("label");
	starThreeLabel.for = "star-3";
	starThreeLabel.classList.add("rating-area");
	ratingArea.append(starThree);
	ratingArea.append(starThreeLabel);

	const starFour = document.createElement("input");
	starFour.type = "radio";
	starFour.id = "star-4";
	starFour.classList.add("rating-area");
	const starFourLabel = document.createElement("label");
	starFourLabel.for = "star-4";
	starFourLabel.classList.add("rating-area");
	ratingArea.append(starFour);
	ratingArea.append(starFourLabel);

	const starFive = document.createElement("input");
	starFive.type = "radio";
	starFive.id = "star-5";
	starFive.classList.add("rating-area");
	const starFiveLabel = document.createElement("label");
	starFiveLabel.for = "star-5";
	starFiveLabel.classList.add("rating-area");
	ratingArea.append(starFive);
	ratingArea.append(starFiveLabel);
});
